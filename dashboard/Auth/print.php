...
<body>
 ...
 <li> <center><button class="btn btn-success" onclick="printDiv('printableArea')" value="print a div!" >Print </button></center> </li>
<!--<li> <center><button class="btn btn-warning" onclick="printContent('div3')">Print Content</button></center> </li>-->
 <li> <center><a href="dashboard/Auth/export.php"><button class="btn btn-danger">EXPORT</button></a></center> </li>
  </ul>
  </div><!--col-md-12-->
</div><!--jumbotron-->
<div class="jumbotron">
  
<div clas="col-md-12" id="printableArea">
    ...
    <table class="table table-bordered" style="table-layout:fixed">
      <thead>
           ...
           <th class="success">Id</th>
            <th class="success" style="width:25%">transactionid</th>
            <th class="success" style="width:9%;">providerRefId</th>
            <th class="success" style="width:5%">PayBill</th>
            <th class="success" style="width:8%;">Productname</th>
            <th class="success" style="width:9%">PhoneNumber</th>
            <th class="success" style="width:7%";>Amount</th>
            <th class="success" style="width:7%;">Transaction fee</th>
            <th class="success" style="width:6%">Stalking%</th>
            <th class="success" style="width:5%;">Status</th>
            <th class="success" style="width:9%;">Description</th>
