  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      ...
      <ul class="nav navbar-nav navbar-right" style="font-size:1.2em;">
        ...
        <li class="active"><a href="../index.html">Website</a></li>
...
<section>
	<div class="container">
		<div class="row">
			...
			<form role="form" class="form-horizontal" action="super_login.php" method="POST" name="contactform">

				<fieldset>
					<legend> <center><span class="glyphicon glyphicon-user"></span>Super ADMIN Login <span class="glyphicon glyphicon-user"></span></center> </legend>
               ...
               <label><input type="checkbox" name="re"> Remember me</label>
						...
						<div class="form-group"
							...
							<center><button class="btn btn-sm btn-primary btn-block" name="login" type="submit" value="<?php if(isset($success)) echo $success; elseif(isset($log_error)) echo $log_error; ?>" style="font-size:1.25em;">Login</button></center>
...
if (isset($_POST['login'])) {
	...
	//remember me not checked
            ...
            $check = " Select * from super WHERE email = '$user_email' AND password = '$pass' ";
            ...
            if (mysqli_num_rows($run)) {
            	...
            	//redirect page
            	 ...
            	 $refresh="<script>window.location.replace('super_login.php' ,'_self')</script>";
            	 sleep(20);  
