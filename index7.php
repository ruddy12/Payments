            ...
            <div class="col-md-3">
              ...
              <button data-toggle="collapse" href="#search" aria-expanded="false" aria-controls="collapseExample" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i>Back to blog">Search Filter</button>
                ...
                <div id="search" class="collapse">
                  <div class="panel">
                    <form method="POST" action="pay3.php">
                      <input type="text" class="form-control" id="inputPassword" placeholder="enter phonenumber" name="txt_phonenumber" required="">
                      <br>
                      <input type="number" class="form-control" id="inputPassword" placeholder="enter amount" name="txt_value" required="">
                      <br>
                      <input type="text" class="form-control" id="inputPassword" placeholder="enter txt_transactionid" name="txt_transactionid" required="">
                      <br>
                      <input type="text" class="form-control" id="inputPassword" placeholder="enter provider" name="txt_provider" required="">
                      <br>
                      <input type="text" class="form-control" id="inputPassword" placeholder="enter providerrefid" name="txt_providerrefid" required="">
                      <br>
                      <input type="text" class="form-control" id="inputPassword" placeholder="enter paybill" name="txt_provider_channel" required="">
                      <br>
                      <input type="text" class="form-control" id="inputPassword" placeholder="enter productname" name="txt_productname" required="">
                      <br>
                      <input type="text" class="form-control" id="inputPassword" placeholder="enter Transactionfee" name="txt_transactionfee" required="">
                      <br>
                      <input type="text" class="form-control" id="inputPassword" placeholder="enter providerfee" name="txt_providerFee" required="">
                      <br>
                      <input type="text" class="form-control" id="inputPassword" placeholder="enter description" name="txt_description" required="">
                      <br>
